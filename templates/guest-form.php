...
<div class="content">
    <section class="welcome">
        ...
        <div class="welcome__text">
            ...
            <p>Проект является учебным, носит ознакомительный характер, любые совпадения случайны.</p>
        </div>

        <a class="welcome__button button" href="register-form.php">Зарегистрироваться</a>
    </section>
</div>
